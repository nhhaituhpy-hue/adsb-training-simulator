...
function SensorPanel({
  ...
  if (!sensor) {
    return (
      <div className="rounded border border-dashed border-[#cbd5e1] bg-[#f8fafc] p-3 text-center">
        <p className="text-xs font-semibold text-[#475569]">Sensor {label}</p>
  ...
  return (
    <div className="min-w-0 rounded border border-[#cbd5e1] bg-white p-3 shadow-[0_1px_2px_rgb(15_23_42/0.04)]">
      <button
        type="button"
      ...
      >
        <span className="flex items-center justify-between gap-2">
          <span className="inline-flex items-center gap-1.5 whitespace-nowrap text-xs font-semibold text-[#172033] sm:text-sm">
            <Monitor aria-hidden size={17} weight="regular" />
            Sensor {label}
          </span>
...
export function SiteItem({
  ...
  return (
    <article className="min-w-0 rounded-lg border border-[#b8c4ce] bg-[#eef3f6] p-3 shadow-[0_2px_6px_rgb(15_23_42/0.08)]">
      <div className="flex items-center justify-between gap-3 border-b border-[#cbd5e1] pb-2.5">
        <h3 className="truncate text-sm font-bold text-[#172033]" title={site.name}>
          {site.name}
        </h3>
        <span className="font-mono text-[11px] tabular-nums text-[#475569]">
